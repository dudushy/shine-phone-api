...
export class GrowattApiService {
  ...
  getPlantEnergyOverview(plantId: string): Observable<ApiResponse<PlantEnergyOverview>> {
    ...
    return this.cachedRequest(
      ...
      this.validateResponse(
        this.http.get<ApiResponse<PlantEnergyOverview>>(`${this.baseUrl}${API_ENDPOINTS.PLANT_DATA}`, {
          params,
        }),
      ),
    );
  ...
  getMinEnergyHistory(
    ...
    return this.cachedRequest(
      key,
      this.validateResponse(
        this.http.get<PaginatedResponse<MinEnergyHistory>>(`${this.baseUrl}${API_ENDPOINTS.MIN_ENERGY_HISTORY}`, {
          params,
        }),
      ),
    );
  ...
  getSphEnergyHistory(
    ...
    return this.cachedRequest(
      key,
      this.validateResponse(
        this.http.get<PaginatedResponse<SphEnergyHistory>>(`${this.baseUrl}${API_ENDPOINTS.SPH_ENERGY_HISTORY}`, {
          params,
        }),
      ),
    );
